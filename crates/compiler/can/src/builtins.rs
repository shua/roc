...
map_symbol_to_lowlevel_and_arity! {
    ...
    StrFromUtf16; STR_FROM_UTF16_LOWLEVEL; 1,
    StrFromUtf16Lossy; STR_FROM_UTF16_LOSSY; 1,
    StrFromUtf32; STR_FROM_UTF32_LOWLEVEL; 1,
    StrFromUtf32Lossy; STR_FROM_UTF32_LOSSY; 1,
